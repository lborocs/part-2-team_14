...
(12, 3, 'Can't wait to test this! When do we get the TestFlight link?'),
...
(17, 7, 'GitLens is a game changer! Can't imagine working without it now.'),
...
(19, 3, 'The console.table() tip is amazing! Why didn't I know about this before?'),
...
-- Carol's tasks
(3, 'Review PR #45', 'Check the navbar component pull request from Grace', 'high', 'pending', '2025-11-05'),
(3, 'Update documentation', 'Add API endpoint documentation to README for new auth routes', 'medium', 'pending', '2025-11-10'),
(3, 'Team standup notes', 'Prepare notes for tomorrow morning standup meeting', 'low', 'completed', '2025-10-28'),
(3, 'Code refactoring', 'Refactor authentication service to use new patterns', 'medium', 'pending', '2025-11-12'),
(3, 'Accessibility testing', 'Test keyboard navigation on all pages', 'high', 'pending', '2025-11-08'),
-- Bob's tasks
(2, 'Sprint planning', 'Prepare user stories for next sprint with acceptance criteria', 'high', 'pending', '2025-11-03'),
(2, 'Code review training', 'Read article on effective code reviews and security considerations', 'low', 'pending', '2025-11-15'),
(2, 'Database optimization', 'Analyze slow queries and add appropriate indexes', 'high', 'pending', '2025-11-06'),
(2, 'Team performance reviews', 'Complete Q4 performance reviews for team members', 'high', 'pending', '2025-11-20'),
-- Emma's tasks
(5, 'AWS certification study', 'Complete module 3 of AWS Solutions Architect course', 'medium', 'pending', '2025-11-20'),
(5, 'Update Docker images', 'Update base Docker images to latest LTS versions', 'medium', 'pending', '2025-11-10'),
(5, 'Kubernetes training', 'Complete Kubernetes fundamentals course', 'low', 'pending', '2025-11-25'),
(5, 'Monitoring dashboard', 'Create Grafana dashboard for API metrics', 'high', 'pending', '2025-11-12'),
-- Frank's tasks
(6, 'Design system updates', 'Update color palette in design system', 'medium', 'pending', '2025-11-08'),
(6, 'Prototype review', 'Review prototype with product team', 'high', 'pending', '2025-11-05'),
(6, 'Icon set creation', 'Create custom icon set for mobile app', 'medium', 'pending', '2025-11-15'),
-- Grace's tasks
(7, 'E2E test suite', 'Write end-to-end tests for checkout flow', 'high', 'pending', '2025-11-10'),
(7, 'Bug bash session', 'Organize bug bash session for mobile app', 'medium', 'pending', '2025-11-07'),
(7, 'Test plan document', 'Create test plan for API v2 endpoints', 'medium', 'pending', '2025-11-12'),
-- Henry's tasks
(8, 'Data migration', 'Write data migration script for user table', 'high', 'pending', '2025-11-14'),
(8, 'API documentation', 'Document all REST API v2 endpoints in OpenAPI format', 'high', 'pending', '2025-11-11'),
(8, 'Database backup', 'Verify database backup procedures', 'medium', 'completed', '2025-10-30'),
-- Iris's tasks
(9, 'Client meeting prep', 'Prepare demo for client meeting on Friday', 'high', 'pending', '2025-11-05'),
(9, 'Budget review', 'Review Q4 project budget and reallocate resources', 'high', 'pending', '2025-11-08'),
(9, 'Risk assessment', 'Update project risk register', 'medium', 'pending', '2025-11-13'),
-- Jack's tasks
(10, 'Security audit report', 'Complete security audit findings report', 'high', 'pending', '2025-11-06'),
(10, 'Vulnerability patches', 'Apply security patches to production servers', 'high', 'pending', '2025-11-04'),
(10, 'Pen test preparation', 'Prepare environments for penetration testing', 'high', 'pending', '2025-11-09');
```
