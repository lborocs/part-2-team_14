...
<body id="manager-progress-page">
  ...
  <div class="deadlines-list" id="deadlines-list"></div>
              ...
              <!-- Gantt Chart Section - Full Width Below -->
...
(function() {
    ...
    // Function to determine task status color (red/amber/green)
    function getTaskStatusColor(task) {
        ...
        // If deadline has passed, it's overdue (red)
        if (now > deadline) {
            return 'status-red';
        }
        
        // If we're in the last 20% of time before deadline, it's at risk (amber)
    ...
    function renderGantt() {
        ...
        ganttData.forEach(user => {
            // Get visible tasks and stack positions
            const taskPositions = [];
    ...
    function showTooltip(task, e) {
        ...
        // Map color class to display color
        let statusColorText = '';
